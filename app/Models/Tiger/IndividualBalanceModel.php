...
class IndividualBalanceModel extends Model
{
    /**
...
// Select CDS.TRS.* 
// from CDS.TRS
// where TRS_TRX_DATE_O='06/25/2021' 
// and TRS_DBR_NO='0028681208' 
// and TRS_SEQ_NO='000005'  
    ...
    public function get_records($filter_data){
        ...
        // DB::enableQueryLog();
        $records = DB::connection('sqlsrv2')->table('tiger.CDS.TRS as a');
