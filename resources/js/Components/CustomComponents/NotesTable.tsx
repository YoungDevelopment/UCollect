...
export const columns: ColumnDef<Message>[] = [
  ...
  },
  {
    ...
    header: "Description",
    cell: ({ row }) => (
      <div className="min-w-[300px] w-full">{row.getValue("description")}</div>
    ),
  },
  {
    accessorKey: "cr",
  ...
  },
  {
    accessorKey: "nextRv",
    header: "NextRv",
    cell: ({ row }) => <div className="w-full">{row.getValue("nextRv")}</div>,
  },
  {
    accessorKey: "txt",
    header: "Txt",
  ...
  },
  {
    accessorKey: "nextDir",
    header: "NextDir",
    cell: ({ row }) => <div className="w-full">{row.getValue("nextDir")}</div>,
  },
  {
    accessorKey: "st",
    header: "St",
