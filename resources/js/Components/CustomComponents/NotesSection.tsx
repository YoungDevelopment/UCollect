...
export const columns: ColumnDef<Message>[] = [
  ...
  },
  {
    accessorKey: "dow",
    header: "DOW",
    cell: ({ row }) => <div className="w-[50px]">{row.getValue("dow")}</div>,
  },
  {
    accessorKey: "uid",
    header: "Uid",
    cell: ({ row }) => <div className="w-[60px]">{row.getValue("uid")}</div>,
  },
  {
  ...
  },
  {
    accessorKey: "dsk",
    header: "Dsk",
    cell: ({ row }) => <div className="w-[50px]">{row.getValue("dsk")}</div>,
  },
  {
    accessorKey: "nextRv",
    header: "NextRv",
    cell: ({ row }) => <div className="w-[70px]">{row.getValue("nextRv")}</div>,
  },
  {
    accessorKey: "txt",
    header: "Txt",
    cell: ({ row }) => <div className="w-[40px]">{row.getValue("txt")}</div>,
  },
  {
    accessorKey: "nextDir",
    header: "NextDir",
...
export const NotesSection = () => {
  ...
  const table = useReactTable({
    ...
    initialState: {
      pagination: {
        pageSize: 10, // Changed from 5 to 10
      },
    },
  });
  ...
  return (
    <Card className="w-full max-w-2xl">
      ...
      <CardContent>
        <NotesTable visibleColumns={["date", "description", "actions", "st"]} />
      </CardContent>
    </Card>
  );
};
